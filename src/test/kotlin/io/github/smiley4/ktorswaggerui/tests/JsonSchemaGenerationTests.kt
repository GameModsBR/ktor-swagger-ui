...
class JsonSchemaGenerationTests : StringSpec({
    ...
    "generate schema for a simple enum" {
        getOApiSchemaBuilder().build(captureType<SimpleEnum>(), ComponentsContext.NOOP, SwaggerUIPluginConfig()) shouldBeSchema {
            type = "string"
    ...
    "generate schema for maps" {
        getOApiSchemaBuilder().build(captureType<DataClassWithMaps>(), ComponentsContext.NOOP, SwaggerUIPluginConfig()) shouldBeSchema {
            type = "object"
            properties = mapOf(
    ...
    "generate schema for a list of simple classes" {
        getOApiSchemaBuilder().build(captureType<Array<SimpleDataClass>>(), ComponentsContext.NOOP, SwaggerUIPluginConfig()) shouldBeSchema {
            type = "array"
    ...
    "generate schema for a simple class" {
        getOApiSchemaBuilder().build(captureType<SimpleDataClass>(), ComponentsContext.NOOP, SwaggerUIPluginConfig()) shouldBeSchema {
            type = "object"
            properties = mapOf(
                "text" to Schema<Any>().apply {
                    type = "string"
    ...
    "generate schema for a another class" {
        getOApiSchemaBuilder().build(captureType<AnotherDataClass>(), ComponentsContext.NOOP, SwaggerUIPluginConfig()) shouldBeSchema {
            type = "object"
            properties = mapOf(
    ...
    "generate schema for a class with inheritance" {
        getOApiSchemaBuilder().build(captureType<SubClassA>(), ComponentsContext.NOOP, SwaggerUIPluginConfig()) shouldBeSchema {
            type = "object"
            properties = mapOf(
    ...
    "generate schema for a class with sub-classes" {
        getOApiSchemaBuilder().build(captureType<Superclass>(), ComponentsContext.NOOP, SwaggerUIPluginConfig()) shouldBeSchema {
            anyOf = listOf(
                Schema<Any>().apply {
                    type = "object"
                    properties = mapOf(
    ...
    "generate schema for a class with nested generic type" {
        getOApiSchemaBuilder().build(
            captureType<WrapperForClassWithGenerics>(),
    ...
    "generate schema for a class with generic types" {
        getOApiSchemaBuilder().build(
            captureType<ClassWithGenerics<SimpleDataClass>>(),
            ComponentsContext.NOOP,
            SwaggerUIPluginConfig()
        ) shouldBeSchema {
            type = "object"
